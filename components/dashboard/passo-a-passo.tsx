...
const steps = [
    ...
    body: (
      <>
        ...
        <p className="mt-2">
          ...
          <strong className="font-semibold text-brand-text">Meu Cadastro</strong> sempre que precisar
      ...
      <>
        ...
        <div className="mt-3 space-y-2">
          {[
            ...
            <div
              key={question}
              className="rounded-xl border-l-4 border-brand-border bg-brand-background px-4 py-3 text-sm italic text-brand-text-muted"
            >
    ...
    body: (
      <>
        <p>
          ...
          <strong className="font-semibold text-brand-text">Indicar Cliente</strong> ou em{" "}
          <strong className="font-semibold text-brand-text">+ Indicar Novo Cliente</strong>.
        </p>
    ...
    body: (
      <>
        <p>
          ...
          <strong className="font-semibold text-brand-text">90 (noventa) dias</strong>.
        </p>
        <p className="mt-2">
  ...
  },
  {
    ...
    body: (
      <>
        <p>
          Utilize <strong className="font-semibold text-brand-text">Minhas Indicações</strong> para
    ...
    body: (
      <>
        ...
        <p className="mt-2">
          ...
          <strong className="font-semibold text-brand-text">a comissão é recorrente</strong>.
        </p>
      </>
    ),
  },
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-3xl border border-brand-border bg-white p-6 shadow-sm sm:p-8">
        ...
        <h1 className="mt-3 text-3xl font-bold tracking-tight text-brand-text">Passo a passo</h1>
        <p className="mt-2 text-base text-brand-text-muted">Da inscrição ao recebimento das suas comissões</p>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-x-2 gap-y-3 rounded-2xl border border-brand-border bg-brand-background p-4 text-xs font-semibold text-brand-text-muted">
          {cicloParceria.map((etapa, index) => (
            <div key={etapa} className="flex items-center gap-2">
              ...
              {index < cicloParceria.length - 1 ? (
                <ArrowRight className="h-3.5 w-3.5 shrink-0 text-brand-text-muted" />
              ) : null}
            </div>
          ))}
        </div>
      ...
      <div className="rounded-3xl border border-brand-border bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-brand-text">Do cadastro à comissão</h2>
      ...
      <div className="rounded-3xl border border-brand-primary/30 bg-brand-primary/10 p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-brand-text">9. Você recebe 10% das mensalidades pagas</h2>
        </div>
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-brand-text-muted">
      ...
      <div className="rounded-3xl border border-brand-border bg-white p-6 shadow-sm sm:p-8">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-2xl font-bold text-brand-text">10. Quando as comissões são pagas?</h2>
        </div>
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-brand-text-muted">
          ...
          <table className="w-full min-w-[420px] text-left text-sm">
            ...
            <tfoot>
              <tr className="border-t border-brand-border bg-brand-background font-semibold text-brand-text">
                ...
                <td className="px-4 py-3 text-right text-brand-text">R$ 120,00</td>
              </tr>
            </tfoot>
          </table>
        </div>
        <p className="mt-3 text-sm text-brand-text-muted">
          ...
          <strong className="font-semibold text-brand-text">R$ 120,00 a receber</strong> no mês
          subsequente.
        </p>
      </div>

      <div className="rounded-3xl border border-brand-border bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-brand-text">11. Acompanhe suas comissões e recebimentos</h2>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-brand-text-muted">
          No Portal, utilize a área <strong className="font-semibold text-brand-text">Comissões</strong>{" "}
        ...
        <div className="mt-5">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-xl bg-brand-dark px-5 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-brand-dark/90"
          >
      ...
      <div className="rounded-3xl border border-brand-border bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-brand-text">Em resumo</h2>
        <ol className="mt-5 space-y-3">
          {resumo.map((item, index) => (
            <li key={item} className="flex items-start gap-3">
              <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-brand-dark text-xs font-bold text-white">
                {index + 1}
              </span>
              <span className="text-sm leading-relaxed text-brand-text-muted">{item}</span>
            </li>
          ))}
        </ol>
      </div>

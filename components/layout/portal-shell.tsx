  ...
  const groups = useMemo<MenuGroup[]>(() => {
    ...
    return [
      { id: "inicio", label: "Início", href: homeHref, icon: Home },
      {
        ...
        icon: Target,
        items: [
          { label: "Indicar Cliente", href: `${basePath}/indicacoes/indicar-cliente` },
      ...
      },
      {
        ...
        items: [
          ...
          { label: "WhatsApp", href: `${basePath}/material-de-vendas/whatsapp` },
      ...
      },
      {
        ...
        icon: GraduationCap,
        items: [
          { label: "Primeiros Passos", href: `${basePath}/treinamentos/primeiros-passos` },
          ...
          { label: "Objeções", href: `${basePath}/treinamentos/objecoes` },

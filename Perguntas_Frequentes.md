...
Acesse a opção **Indicar Cliente** no Portal, informe os dados
solicitados e registre a indicação.
...
A indicação fica vinculada a você por **90 dias**.

Durante esse período, a equipe da Catedral poderá entrar em contato com
...
Se a contratação não for concluída dentro do prazo de 90 dias, o período
...
Acesse **Minhas Indicações** no Portal.
...
## Preciso fazer a venda do Sistema Catedral?

Não.

Seu papel é identificar uma oportunidade, conversar com o possível
cliente e registrar a indicação.
...
É importante conhecer os principais benefícios e argumentos de venda,
mas você não precisa responder questões técnicas que não domina.
...
As comissões são pagas no mês subsequente ao pagamento realizado pelo
cliente indicado.
...
## Onde encontro materiais para apresentar o Sistema Catedral?

Acesse **Material de Vendas** no Portal.
...
> "Prefiro pedir para um consultor da Catedral explicar isso
...
## Como falo com o responsável pelo Programa de Parceiros?
...
Se não encontrou a resposta que procurava, acesse **Falar com a
Catedral** e envie sua mensagem pelo WhatsApp.
